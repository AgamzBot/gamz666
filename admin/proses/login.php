    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col text-center">
                <form action="" method="post" class="rounded bg-dark px-3 py-3" style="margin-top:200px;">
                    <table width="100%">
                        <tr>   
                            <h2 class="text-center text-light"><strong>Login Admin</strong> </h2>
        ...
        <p class="text-center text-danger"><strong>Username : admin ||| Password : admin</strong></p>
